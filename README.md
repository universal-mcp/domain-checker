...
You can start using Domain-checker directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Domain-checker.
...
The full list of available tools is at [Tools](./src/universal_mcp_domain_checker/README.md)
...
3. **Start the MCP Inspector**
   ...
   ```bash
   mcp dev src/universal_mcp_domain_checker/server.py
   ```
